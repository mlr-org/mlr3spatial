...
This benchmark was run on a MacBook Pro 2021 M1 Pro. If you rerun this
result on your machine, your results will differ - both in relative and
absolute values and maybe by a lot. This is due to the multicore
...
part of the speedup of the `mlr3-all-cores` setting.

Also note that using all available cores does not always result in
