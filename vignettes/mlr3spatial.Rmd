...
First, the TIFF files is read via `stars::read_stars()` and put into a `DataBackendSpatial`.
...
The color vector is extract from the viridis color palette via `dput(viridis::viridis_pal()(7))`.

```{r}
plot(ras, col = c("#440154FF", "#443A83FF", "#31688EFF", "#21908CFF", "#35B779FF",
  "#8FD744FF", "#FDE725FF"))
```
