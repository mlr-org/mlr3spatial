...
#> 1 1-mlr3-terra-sequential     25.1s    26.3s     3    21       1.3m <bench_tm [3]> <tibble [3 × 3]>
#> 2 2-mlr3-raster-sequential    22.7s    23.7s     3    11      1.18m <bench_tm [3]> <tibble [3 × 3]>
#> 3 3-terra-sequential          26.6s    28.7s     3    17       1.4m <bench_tm [3]> <tibble [3 × 3]>
#> 4 4-raster-sequential           24s    26.8s     3    12      1.33m <bench_tm [3]> <tibble [3 × 3]>
#> 5 5-mlr3-terra-4-cores          18s      19s     3     7     59.58s <bench_tm [3]> <tibble [3 × 3]>
#> 6 6-mlr3-raster-4-cores       13.8s    14.5s     3     8     46.19s <bench_tm [3]> <tibble [3 × 3]>
#> 7 7-terra-4-cores             43.6s    46.5s     3    11      2.35m <bench_tm [3]> <tibble [3 × 3]>
#> 8 8-raster-4-cores            20.7s    21.4s     3     1      1.06m <bench_tm [3]> <tibble [3 × 3]>
```
