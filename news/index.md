...
- fix: `DataBackendRaster` no longer errors when raster layers have
  ...
  e.g. [`predict_spatial()`](https://mlr3spatial.mlr-org.com/reference/predict_spatial.md)
...
- BREAKING CHANGE: `TaskUnsupervised` is used to predict on rasters
  ...
  response.
- feat: Add
  [`as_task_regr_st()`](https://mlr3spatial.mlr-org.com/reference/as_task_regr_st.md)
  and
