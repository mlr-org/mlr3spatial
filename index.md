...
The function
[`as_task_classif_st()`](https://mlr3spatial.mlr-org.com/reference/as_task_classif_st.md)
converts the
[`sf::sf`](https://r-spatial.github.io/sf/reference/sf.html) object to a
...
![](reference/figures/sentinel.png)
...
to the
[`predict_spatial()`](https://mlr3spatial.mlr-org.com/reference/predict_spatial.md)
function.
...
mlr3spatiotempcv is solely devoted to resampling techniques. There are
quite a few and keeping packages small is one of the development
